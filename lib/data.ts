  ...
  const automotive = [
    {
      ...
      title: "Michelin Pilot Sport 4S Performance Tire 245/40R18",
      description: "Ultimate grip in wet and dry conditions. The Pilot Sport 4S delivers exceptional performance with Dynamic Response Technology and a hybrid compound for longer tread life.",
      price: 289,
      compareAtPrice: 329,
      brand: "Michelin",
      category: "Automotive",
      ...
      reviewCount: 4567,
      stock: 200,
      specifications: { "Size": "245/40R18", "Type": "Performance", "Season": "Summer", "Load Index": "97Y" },
      features: ["Dynamic Response Technology", "Hybrid compound", "Premium Touch sidewall design", "Exceptional wet grip"],
      tags: ["michelin", "tire", "performance", "automotive"],
      freeShipping: true,
      shippingTime: "3-5 days",
    },
    {
      id: "bosch-car-battery",
      title: "Bosch S5 Premium AGM Car Battery 12V 95Ah",
      description: "Superior starting power and deep cycle capability. The Bosch S5 AGM battery delivers exceptional performance for vehicles with start-stop systems and high electrical demands.",
      price: 249,
      compareAtPrice: 299,
      brand: "Bosch",
      category: "Automotive",
      ...
      reviewCount: 3456,
      stock: 150,
      specifications: { "Voltage": "12V", "Capacity": "95Ah", "CCA": "850A", "Technology": "AGM" },
      features: ["AGM technology", "Start-stop compatible", "Vibration resistant", "Maintenance-free", "3-year warranty"],
      tags: ["bosch", "battery", "agm", "automotive"],
      freeShipping: true,
      shippingTime: "2-4 days",
    },
    {
      id: "dewalt-mechanic-toolset",
      title: "DeWalt 205-Piece Mechanics Tool Set with Case",
      description: "Professional-grade mechanic tools for every job. This comprehensive 205-piece set includes ratchets, sockets, wrenches, and more in a durable carry case.",
      price: 199,
      compareAtPrice: 259,
      brand: "DeWalt",
      category: "Automotive",
      subcategory: "Tools & Equipment",
      images: ["https://images.unsplash.com/photo-1530124566582-a45a7c0be13a?w=800"],
      rating: 4.9,
      reviewCount: 8901,
      stock: 340,
      specifications: { "Pieces": "205", "Drive Sizes": "1/4\", 3/8\", 1/2\"", "Material": "Chrome Vanadium Steel", "Case": "Blow-mold" },
      features: ["72-tooth ratchets", "Chrome vanadium steel", "Full polish finish", "Heavy duty case", "Lifetime warranty"],
      tags: ["dewalt", "tools", "mechanic", "automotive"],
      freeShipping: false,
      shippingTime: "3-5 days",
    },
    {
      id: "led-interior-lights",
      title: "Govee RGBIC Car LED Interior Lights with Smart App Control",
      description: "Transform your car interior with dynamic lighting. The Govee RGBIC strip lights feature multi-color modes, music sync, and smart app control for the ultimate driving ambiance.",
      price: 49,
      compareAtPrice: 69,
      brand: "Govee",
      category: "Automotive",
      ...
      reviewCount: 12345,
      stock: 890,
      specifications: { "Length": "48 inches total", "LEDs": "RGBIC Multi-Color", "Control": "App + Voice", "Power": "12V DC" },
      features: ["RGBIC multi-color", "Music sync mode", "App control", "Easy installation", "16 million colors"],
      tags: ["govee", "led", "interior", "automotive", "lights"],
      freeShipping: false,
      shippingTime: "2-4 days",
    },
    {
      id: "dash-cam-vantrue",
      title: "Vantrue N4 3-Channel Dash Cam 4K+1080P Front, Inside & Rear",
      description: "Complete 360° vehicle protection with 3 cameras. The Vantrue N4 records in 4K front, 1080P inside, and 1080P rear simultaneously for maximum coverage.",
      price: 299,
      compareAtPrice: 349,
      brand: "Vantrue",
      category: "Automotive",
      ...
      reviewCount: 6789,
      stock: 120,
      specifications: { "Resolution": "4K + 1080P + 1080P", "Channels": "3", "Storage": "Up to 256GB", "Night Vision": "Infrared" },
      features: ["3-channel recording", "4K front camera", "IR night vision", "24H parking mode", "GPS tracking"],
      tags: ["dashcam", "vantrue", "camera", "automotive", "safety"],
      freeShipping: true,
      shippingTime: "2-3 days",
    },
  ];
  ...
  const books = [
    {
      ...
      description: "The #1 New York Times bestseller. An easy and proven way to build good habits and break bad ones. Tiny changes, remarkable results.",
      price: 24,
      compareAtPrice: 30,
      brand: "Penguin",
      ...
      reviewCount: 89012,
      stock: 500,
      specifications: { "Pages": "320", "Format": "Hardcover", "Language": "English", "Publisher": "Avery" },
      features: ["NYT Bestseller", "Practical strategies", "Science-backed", "Actionable framework"],
    ...
    },
    {
      ...
      description: "From the author of The Martian. A lone astronaut must save the earth from disaster in this propulsive interstellar adventure. A dream book for science fiction fans.",
      price: 16,
      compareAtPrice: 20,
      brand: "Ballantine",
      category: "Books & Media",
      ...
      reviewCount: 45678,
      stock: 340,
      specifications: { "Pages": "496", "Format": "Paperback", "Language": "English", "Publisher": "Ballantine Books" },
      features: ["Award-winning sci-fi", "From The Martian author", "Page-turner", "Science-rich narrative"],
      tags: ["book", "sci-fi", "fiction", "andy-weir"],
      freeShipping: false,
      shippingTime: "2-4 days",
    },
    {
      ...
      description: "The bestselling Python programming book. A hands-on, project-based introduction to Python. Perfect for beginners who want to learn programming fast.",
      price: 35,
      compareAtPrice: 45,
      ...
      reviewCount: 23456,
      stock: 290,
      specifications: { "Pages": "552", "Format": "Paperback", "Language": "English", "Edition": "3rd" },
      features: ["Project-based learning", "Covers Python 3", "Game & web projects", "Data visualization"],
      tags: ["book", "python", "programming", "education"],
      freeShipping: false,
      shippingTime: "2-4 days",
    },
    {
      ...
      description: "Professional features at an accessible price. The AT-LP120XUSB delivers high-fidelity vinyl playback with USB output for digitizing your record collection.",
      price: 349,
      compareAtPrice: 399,
      brand: "Audio-Technica",
      category: "Books & Media",
      subcategory: "Music",
      images: ["https://images.unsplash.com/photo-1539375665275-f9de415ef9ac?w=800"],
      rating: 4.8,
      reviewCount: 15678,
      stock: 78,
      specifications: { "Drive": "Direct Drive", "Speeds": "33/45/78 RPM", "USB": "Yes", "Cartridge": "AT-VM95E" },
      features: ["Direct-drive motor", "USB output", "Anti-resonance platter", "Adjustable tracking force", "Built-in preamp"],
      tags: ["turntable", "vinyl", "audio-technica", "music"],
      freeShipping: true,
      shippingTime: "3-5 days",
    },
    {
      id: "4k-blu-ray-collection",
      title: "Christopher Nolan 4K UHD Collection - 7 Film Box Set",
      description: "Experience Nolan's masterpieces in stunning 4K. Includes The Dark Knight Trilogy, Inception, Interstellar, Dunkirk, and Tenet in 4K Ultra HD + Blu-ray.",
      price: 89,
      compareAtPrice: 120,
      brand: "Warner Bros",
      category: "Books & Media",
      subcategory: "Movies & TV",
      images: ["https://images.unsplash.com/photo-1460881680858-30d872d5b530?w=800"],
      rating: 4.9,
      reviewCount: 8901,
      stock: 145,
      specifications: { "Format": "4K UHD + Blu-ray", "Films": "7", "Audio": "Dolby Atmos", "Discs": "14" },
      features: ["4K Ultra HD", "Dolby Atmos audio", "7 iconic films", "Special features included", "Collector's packaging"],
      tags: ["blu-ray", "4k", "nolan", "movies", "collection"],
      freeShipping: true,
      shippingTime: "2-3 days",
    },
  ];
...
export const filterProducts = (
  ...
  if (filters.category) {
    // Support both slug and full name matching
    const cat = categories.find(c => c.slug === filters.category?.toLowerCase());
    const categoryName = cat ? cat.name : filters.category;
    result = result.filter(
